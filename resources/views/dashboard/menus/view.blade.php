...
<div class="container-fulied">
    <nav aria-label="breadcrumb" >
        ...
        <ol class="breadcrumb py-0 my-0" style="@lang('theme.actionline')">
                <a class="btn btn-sm @lang('theme.btn_edit') btn-x py-1 px-3 mb-2 font-weight-bolder" href="{{ route('menu.edit', [$menu]) }}">Edit</a>
        </ol>
    </nav>
        @includeIf('dashboard.menus.form', ['mode' => 'EDIT','editable' => false])
</div>
@endsection
