                        ...
                        <div class="card-body pad">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder="Enter value1" name="details[data1][value]" value="" {{$editable?'':' disabled'}} >
                                        @if ($errors->has('name_en'))
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('name_en') }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" placeholder="Enter Date Sinhala" name="$details[data2][label_en]" value="{{ $details['data2']['label_si'] ?? null }}" {{$editable?'':' disabled'}} >
                                        @if ($errors->has('name_en'))
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('name_en') }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" placeholder="Enter Date Sinhala" name="$details[data2][label_en]" value="{{ $details['data2']['label_ta'] ?? null }}" {{$editable?'':' disabled'}} >
                                        @if ($errors->has('name_en'))
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('name_en') }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    <label for="name">Value 2</label>
                                        <input type="text" class="form-control form-control-sm" placeholder="Enter Date Sinhala" name="$details[data2][value]" value="" {{$editable?'':' disabled'}} >
                                        @if ($errors->has('name_en'))
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('name_en') }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    <label for="name">Data 3</label>
                                        <input type="text" class="form-control form-control-sm" placeholder="Enter Date Sinhala" name="name_en" value="" {{$editable?'':' disabled'}} >
                                        @if ($errors->has('name_en'))
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('name_en') }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" placeholder="Enter Date Sinhala" name="$details[data2][label_en]" value="" {{$editable?'':' disabled'}} >
                                        @if ($errors->has('name_en'))
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('name_en') }}</strong>
                                            </span>
                                                ...
                                                @for($h=1; $h<=4; $h++)
                                                    <th>
                                                        @foreach(['en','si','ta'] as $k)
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm" placeholder="table heading{{$h}} name_{{$k}}" name="details[tbl1_h{{$h}}][name_{{$k}}]" value="" {{$editable?'':' disabled'}} >
                                                                @if ($errors->has('name_en'))
                                                                    <span class="invalid-feedback">
                                                                        <strong>{{ $errors->first('name_en') }}</strong>
                                                                    </span>
                                                ...
                                                <tr>
                                                    @for($c=1; $c<=4; $c++)
                                                        <td>
                                                            @foreach(['en','si','ta'] as $k)
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control form-control-sm" placeholder="table row{{$r}} column{{$c}} name_{{$k}}" name="details[tbl1_r{{$r}}c{{$c}}][name{{$k}}]" value="" {{$editable?'':' disabled'}} >
                                                                    @if ($errors->has('name_en'))
                                                                        <span class="invalid-feedback">
                                                                            <strong>{{ $errors->first('name_en') }}</strong>
                                                                        </span>
                                            ...
                                            <tr>
                                                @for($h=1; $h<=3; $h++)
                                                    <th>
                                                        @foreach(['en','si','ta'] as $k)
                                                            <div class="form-group">
                                                                <input type="text" class="form-control form-control-sm" placeholder="table heading{{$h}} name_{{$k}}" name="details[tbl2_h{{$h}}][name_{{$k}}]" value="" {{$editable?'':' disabled'}} >
                                                                @if ($errors->has('name_en'))
                                                                    <span class="invalid-feedback">
                                                                        <strong>{{ $errors->first('name_en') }}</strong>
                                                                    </span>
                                                ...
                                                <tr>
                                                    @for($c=1; $c<=3; $c++)
                                                        <td>
                                                            @foreach(['en','si','ta'] as $k)
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control form-control-sm" placeholder="table row{{$r}} column{{$c}} name_{{$k}}" name="details[tbl2_r{{$r}}c{{$c}}][name{{$k}}]" value="" {{$editable?'':' disabled'}} >
                                                                    @if ($errors->has('name_en'))
                                                                        <span class="invalid-feedback">
                                                                            <strong>{{ $errors->first('name_en') }}</strong>
                                                                        </span>
