...
<div class="container-fulied">
    <nav aria-label="breadcrumb" >
        ...
        <ol class="breadcrumb py-0 my-0" style="@lang('theme.actionline')">
                <a class="btn btn-sm @lang('theme.btn_edit') btn-x py-1 px-3 mb-2 font-weight-bolder" href="{{ route('notice.edit', [$notice]) }}">Edit</a>
        </ol>
    </nav>
        @includeIf('dashboard.notices.form', ['mode' => 'EDIT','editable' => false])
</div>
@endsection
