...
<div class="container-fulied">
    <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('notice.update', [$notice]) }}">
        @csrf
        ...
        <input type="hidden" value="{{$notice->updated_at}}" name="updated_at">
        @includeIf('dashboard.notices.form', ['mode' => 'EDIT', 'editable' => true])
    </form>
</div>
@endsection
