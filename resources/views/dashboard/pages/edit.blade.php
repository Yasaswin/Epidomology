...
<div class="container-fulied">
    <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('page.update', [$page]) }}">
        @csrf
        ...
        <input type="hidden" value="{{$page->updated_at}}" name="updated_at">
        @includeIf('dashboard.pages.form', ['mode' => 'EDIT', 'editable' => true])
    </form>
</div>
@endsection
